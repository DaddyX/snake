...
use app\common\model\VidTv;
use app\common\model\VidCartoon;
...
class AppTruth extends ApiBase {
    ...
    public function questionList() {
        ...
        $words = VidFilm ::where("type", 1) -> column("content");
        $crazy = VidFilm ::where("type", 2) -> column("content");
    ...
    public function contact() {
        ...
        switch ($MsgType) {
            ...
            case "image"://接受图片消息
                $sendParams['msgtype'] = 'link';
                $sendParams['link']['title'] = urlencode('六妹的日常污');
                $sendParams['link']['description'] = urlencode('关注爱上不打扰，六妹带你涨姿势');
                $sendParams['link']['url'] = urlencode('https://mp.weixin.qq.com/s/N1zKtliPPnSFdfbw_iardA');
                $sendParams['link']['thumb_url'] = urlencode('https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=4147109947,984271539&fm=26&gp=0.jpg');
                break;
